...
<head>
	...
	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/chatBox.css">
	...
	<!--Script que oculta y muestra el chat -->
	<script src="<?php echo $url; ?>vistas/js/chatBox.js"></script>
