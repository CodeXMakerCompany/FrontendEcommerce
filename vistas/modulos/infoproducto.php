			...
			?>
				...
				<?php
					...
					echo '<div class="comprarAhora" style="display:none">
						...
						<button class="btn btn-default backModo quitarItemCarrito" idProducto="'.$infoproducto["id"].'" peso="'.$infoproducto["peso"].'"></button>
				...
				<?php
					...
					if($infoproducto["detalles"] != null){
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							if($detalles["Escala"]!=null){

								echo '<div class="col-md-3 col-xs-12">

									<select class="form-control seleccionarDetalle" id="seleccionarEscala">
										
										<option value="">Escala</option>';

										for($i = 0; $i <= count($detalles["Escala"]); $i++){

											echo '<option value="'.$detalles["Escala"][$i].'">'.$detalles["Escala"][$i].'</option>';
							...
							if($detalles["Modo"]!=null){

								echo '<div class="col-md-3 col-xs-12">

									<select class="form-control seleccionarDetalle" id="seleccionarModo">
										
										<option value="">Modo</option>';

										for($i = 0; $i <= count($detalles["Modo"]); $i++){

											echo '<option value="'.$detalles["Modo"][$i].'">'.$detalles["Modo"][$i].'</option>';
							...
							if($detalles["Disponibilidad"]!=null){

								echo '<div class="col-md-3 col-xs-12">

									<select class="form-control seleccionarDetalle" id="seleccionarDisponibilidad">
										
										<option value="">Disponibilidad</option>';

										for($i = 0; $i <= count($detalles["Disponibilidad"]); $i++){

											echo '<option value="'.$detalles["Disponibilidad"][$i].'">'.$detalles["Disponibilidad"][$i].'</option>';
							...
							echo '<div class="col-xs-12">
								...
								<li>
									<i style="margin-right:10px" class="fa fa-play-circle"></i> '.$detalles["Modelo"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-clock-o"></i> '.$detalles["Serie"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-check-circle"></i> '.$detalles["Autor"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-info-circle"></i> '.$detalles["Diseño"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-desktop"></i> '.$detalles["Calidad"].'
								</li>
								<li>
									<i style="margin-right:10px" class="fa fa-trophy"></i> '.$detalles["Firma"].'
								</li>
					...
					if($infoproducto["precio"]==0){
						...
						if(isset($_SESSION["validarSesion"]) && $_SESSION["validarSesion"] == "ok"){
							...
							if($infoproducto["tipo"]=="virtual"){
								...
								echo '<button class="btn btn-default btn-block btn-lg backModo agregarGratis" idProducto="'.$infoproducto["id"].'" idUsuario="'.$_SESSION["id"].'" tipo="'.$infoproducto["tipo"].'" titulo="'.$infoproducto["titulo"].'">ACCEDER AHORA</button>';

							}else{

								echo '<button class="btn btn-default btn-block btn-lg backModo agregarGratis" idProducto="'.$infoproducto["id"].'" idUsuario="'.$_SESSION["id"].'" tipo="'.$infoproducto["tipo"].'" titulo="'.$infoproducto["titulo"].'">SOLICITAR AHORA</button>
							...
							echo '<a href="#modalIngreso" data-toggle="modal">
								...
								<button class="btn btn-default btn-block btn-lg backModo">	SOLICITAR AHORA</button>
						...
						if($infoproducto["tipo"]=="virtual"){
							...
							echo '</div>
								...
								if($infoproducto["oferta"] != 0){
									...
									echo '<button class="btn btn-default btn-block btn-lg backModo agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precioOferta"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';

								}else{

									echo '<button class="btn btn-default btn-block btn-lg backModo agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" tipo="'.$infoproducto["tipo"].'" peso="'.$infoproducto["peso"].'">';
			...
			<div class="col-xs-12 tituloDestacado">
				...
				<?php
					...
					echo '<a href="'.$url.$rutaArticulosDestacados[0]["ruta"].'">
						...
						<button class="btn btn-default backModo pull-right">
						...
						<h4>
							...
							<small>
								...
								<a href="'.$url.$value["ruta"].'" class="pixelProducto">
									...
									<span style="Modo:rgba(0,0,0,0)">-</span>';
...
<div id="modalComprarAhora" class="modal fade modalFormulario" role="dialog">
	 ...
	 <div class="modal-content modal-dialog">
		...
		<div class="modal-body modalTitulo">
			...
			<h3 class="backModo">REALIZAR PAGO</h3>
			...
			<div class="contenidoCheckout">
				...
				<div class="listaProductos row">
					...
					<form class="formPayu" style="display:none">
					  ...
					  <input name="Submit" class="btn btn-block btn-lg btn-default backModo" type="submit"  value="PAGAR" >
					</form>
					
					<button class="btn btn-block btn-lg btn-default backModo btnPagar">PAGAR</button>
