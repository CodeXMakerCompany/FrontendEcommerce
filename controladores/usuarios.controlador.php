			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('support@codexmaker.com', 'Gear Project Shop');

					$mail->addReplyTo('support@codexmaker.com', 'Gear Project Shop');
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->setFrom('codexmakerdomi01@gmail.com', 'Gear Project');

					$mail->addReplyTo('codexmakerdomi01@gmail.com', 'Gear Project');

					$mail->Subject = "Ha recibido una consulta";

					$mail->addAddress("contacto@coddexmaker.com");

					$mail->msgHTML('

						<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">

						<center><img style="padding:20px; width:10%" src="https://backend.codexmaker.com/vistas/img/plantilla/logo_GearProject.png"></center>
